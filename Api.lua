...
local keyboard = {}
keyboard.inline_keyboard = {{{text = '▪️ تنظیمات و مدیریت گروه ', callback_data = 'Menu:'..chat_id}},{{text= '▪️ بستن فهرست مدیریتی' ,callback_data = 'Exit:'..chat_id}},{{text="▪️ کانال تیم ما",url="https://telegram.me/morgan_team"}}}
AnswerInline(Company.id,'settings','Group settings',chat_id,'▪️ به فهرست مدیریتی گروه خوش آمدید','Markdown',keyboard)
else
local keyboard = {}
keyboard.inline_keyboard = {{{text="▪️ کانال تیم ما",url="https://telegram.me/morgan_team"}}}			
