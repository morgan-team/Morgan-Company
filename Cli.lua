...
if redis:get('CheckBot:'..msg.chat_id) then
local text = '`⇋ گروه '..Company.title..' از قبل در لیست گروه های مدیریتی وجود دارد.`\n\n⇋ @morgan_team'
 sendText(msg.chat_id, msg.id,text,'md')
else
...
redis:setex("ExpireData:"..msg.chat_id,day,true)
 ...
 redis:sadd("group:",msg.chat_id)
if redis:get('CheckBot:'..msg.chat_id) then
local text = '`✪ Group '..Company.title..' Is AlReady Added to Management List. `\n\n @morgan_team'
 sendText(msg.chat_id, msg.id,text,'md')
else
local text = '`✪ Group '..Company.title..' Added to Management List. `\n\n @morgan_team'
local Hash = 'StatsGpByName'..msg.chat_id
local ChatTitle = Company.title
redis:set(Hash,ChatTitle)
print('⇋ New Group\nChat name : '..Company.title..'\nChat ID : '..msg.chat_id..'\nBy : '..msg.sender_user_id)
local textlogs =[[
✪ New Group Added to Management List‼️

✪ Group Informations❕:

✪ Group Name ]]..Company.title..[[

✪ Group Id : ]]..msg.chat_id..[[
...
sendText(msg.chat_id,msg.id,'`⇋ سیستم ربات بروز شد. `\n\n⇋ @morgan_team','md')
end 
...
io.popen("rm -rf ~/.telegram-bot/main/files/videos/*")
io.popen("rm -rf ~/.telegram-bot/main/files/voice/*")
sendText(msg.chat_id,msg.id,'`✪ Rex Bot Successfully Reloaded.`\n\n⇋ @morgan_team','md')
end 
...
redis:del('CheckExpire:'..msg.chat_id)
 if not redis:get('CheckBot:'..msg.chat_id) then
local text = '`✪ Group  '..Company.title..' Is Note Added to Management List.`'
 sendText(msg.chat_id, msg.id,text,'md')
else
local text = '`✪ Group  '..Company.title..'  Removed From Management List.`'
local Hash = 'StatsGpByName'..msg.chat_id
redis:del(Hash)
 sendText(msg.chat_id, msg.id,text,'md')
 redis:del('CheckBot:'..msg.chat_id) 
...
redis:set("ExpireData:"..msg.chat_id,true)
sendText(msg.chat_id ,msg.id,"`✪ Group Charged Unlimited.`",'md')
if redis:get('CheckExpire:'..msg.chat_id) then
redis:set('CheckExpire:'..msg.chat_id,true)
end
end
...
sendDocument(Sudoid, 0, 0, 1, nil, './Config.lua', dl_cb, nil)
sendDocument(Sudoid, 0, 0, 1, nil, './Api.lua', dl_cb, nil)
sendText(msg.chat_id, msg.id,'`✪ The Latest Version of The Source Was Sent To The Developer of The Robot.`','md')
end
...
sendText(msg.chat_id, msg.id,  "`✪ The robot leaves the group.`", 'md' )
Left(msg.chat_id, TD_ID, 'Left')
end
...
redis:del('ChatSuper:Bot')
 redis:del('Chat:Normal')
 redis:del('ChatPrivite')
sendText(msg.chat_id, msg.id,'`✪ Sᴛᴀᴛɪsᴛɪᴄs Bᴏᴛ Rᴇsᴇᴛᴇᴅ.`',  'md' )
end
...
if matches == 'setowner' then
local function SetOwner_Rep(MaTaDoR, Company)
local user = Company.sender_user_id
if redis:sismember('OwnerList:'..msg.chat_id,user) then
SendMetion(msg.chat_id,Company.sender_user_id, msg.id, '✪ The User:  '..Company.sender_user_id..' is AlReady Added In the List of Owners of The Group ', 10,string.len(Company.sender_user_id))
else
SendMetion(msg.chat_id,Company.sender_user_id, msg.id, '✪ The User:  '..Company.sender_user_id..' Has Been Added to the List of Owners of The Group. ', 10,string.len(Company.sender_user_id))
redis:sadd('OwnerList:'..msg.chat_id,user or 00000000)
end
end
if tonumber(msg.reply_to_message_id) == 0 then
...
sendText(msg.chat_id,msg.id,"`⇋ تمام مدیران گروه به رسمیت شناخته شدند.`\n\n⇋ @morgan_team", "md")
end
...
sendText(msg.chat_id,msg.id,"`✪ All Group Managers were Recognized.`\n\n⇋ @morgan_team", "md")
end
getChannelMembers(msg.chat_id,'Administrators',0,limit,GetMod)
end
if is_Owner(msg) then
if matches == 'راهنما' or matches == 'help' then
sendText(msg.chat_id,msg.id,'`help bot in this channel:` https://t.me/morganCompanyHelp','md')
end
end
if is_Owner or is_member or is_mod (msg) then
if matches == 'creator' or matches == 'سازنده' then
sendText(msg.chat_id,msg.id,'`⇋ ویرایش شده توسط   :`\n⇋ @shiekh_mamad \n\n`⇋ کانال تیم ما  :` @morgan_team','md')
end
end
if is_Owner or is_mod (msg) then
if matches == 'نرخ' or matches == 'nerkh' then
sendText(msg.chat_id,msg.id,'💵 نرخ فروش ربات \n\n✪ برای تمام گروه ها‌\n\n`⇋1 ماهه 8 هزار تومان `\n`⇋2 ماهه 16 هزار تومان`\n`⇋3 ماهه  24 هزار تومان`\n`⇋4 ماهه  32 هزار تومان`\n\n🔹 نکته مهم :\n\n`➖توجه داشته باشید ربات به مدت  ۴۸ ساعت رایگان برای تست در گروه نصب می‌شود و بعد تست و رضایت کامل اعمالات صورت می‌گیرد✔️\n\n`⇋ @morgan_team','md')
end
end
if matches == 'انلاینی' then
sendText(msg.chat_id,msg.id,'Re😐🖤','md')
end
...
sendText(msg.chat_id, msg.id,'⇋ تمام کاربران دیلیت اکانتی از گروه حذف شدند.' ,'md')
end
...
if matches == 'promote' then
function PromoteByReply(MaTaDoR,Company)
redis:sadd('ModList:'..msg.chat_id,Company.sender_user_id)
local user = Company.sender_user_id
SendMetion(msg.chat_id,user, msg.id, '✪ User : '..user..' Promoted.', 10,string.len(user))
end
if tonumber(msg.reply_to_message_id_) == 0 then
else
getMessage(msg.chat_id, tonumber(msg.reply_to_message_id), PromoteByReply)  
...
if matches == 'demote' then
function DemoteByReply(MaTaDoR,Company)
redis:srem('ModList:'..msg.chat_id,Company.sender_user_id)
SendMetion(msg.chat_id,Company.sender_user_id, msg.id, '✪ User : '..Company.sender_user_id..' Demoted.', 10,string.len(Company.sender_user_id))
end
if tonumber(msg.reply_to_message_id) == 0 then
else
getMessage(msg.chat_id, tonumber(msg.reply_to_message_id),DemoteByReply)  
...
if matches == 'قفل همه' then
redis:set('MuteAll:'..msg.chat_id,true)
sendText(msg.chat_id, msg.id,'⇋ قفل همه فعال شد.' ,'md')
end
if matches == 'lock all' then
redis:set('MuteAll:'..msg.chat_id,true)
sendText(msg.chat_id, msg.id,'✪ Lock All Has Been Enable.' ,'md')
end
...
sendText(msg.chat_id, msg.id,'⇋ قفل همه غیرفعال شد' ,'md')
end
if matches == 'unlock all' then
redis:del('MuteAll:'..msg.chat_id)
local mutes =  redis:smembers('Mutes:'..msg.chat_id)
for k,v in pairs(mutes) do
redis:srem('MuteList:'..msg.chat_id,v)
...
sendText(msg.chat_id, msg.id,'✪ Lock All Has Been Disable.' ,'md')
end
...
if matches == 'panel' or matches == 'پنل' then
...
if redis:get('Lock:Cmd'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل دستورات از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Cmd'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lock cmd is AlReady Enabled.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lock cmd Has Been Enable.`' , 'md')
redis:set('Lock:Cmd'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل دستورات از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock cmd' then
if redis:get('Lock:Cmd'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lock cmd Has Been Disable.`' , 'md')
redis:del('Lock:Cmd'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lock cmd is AlReady Disabled.`' , 'md')
end
end
if matches == 'قفل فونت' then
if redis:get('Lock:Markdown:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل فونت از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Markdown:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lock MarkDown is AlReady Enabled.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lock MarkDown Has Been Enable.`' , 'md')
redis:set('Lock:Markdown:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل فونت از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock markdown' then
if redis:get('Lock:Markdown:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lock MarkDown Has Been Disable.`' , 'md')
redis:del('Lock:Markdown:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lock MarkDown is AlReady Disabled.`' , 'md')
end
end
if matches == 'قفل عنوان' then
if redis:get('Mute:Caption:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل عنوان از قبل فعال بود.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`⇋ قفل عنوان فعال شد.`' , 'md')
redis:set('Mute:Caption:'..msg.chat_id,true)
end
end
if matches == 'lock caption' then
if redis:get('Mute:Caption:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lock Caption is AlReady Enabled.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lock Caption Has Been Enable.`' , 'md')
redis:set('Mute:Caption:'..msg.chat_id,true)
end
end
if matches == 'بازکردن عنوان' then
if redis:get('Mute:Caption:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل عنوان غیرفعال شد.`' , 'md')
redis:del('Mute:Caption:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`⇋ قفل عنوان از قبل غیرفعال بود.`' , 'md')
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل ریپلای از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Reply:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Rᴇᴘʟʏ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Rᴇᴘʟʏ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Reply:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل ریپلای از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock reply' then
if redis:get('Mute:Reply:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Rᴇᴘʟʏ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Reply:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Rᴇᴘʟʏ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل لینک' then
if redis:get('Lock:Link'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل لینک از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Link'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lɪɴᴋ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lɪɴᴋ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Link'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل لینک از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock link' then
if redis:get('Lock:Link'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lɪɴᴋ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Link'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lɪɴᴋ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل تگ' then
if redis:get('Lock:Tag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل تگ از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Tag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴀɢ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴀɢ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Tag:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل تگ از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock tag' then
if redis:get('Lock:Tag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴀɢ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Tag:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴀɢ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل هشتگ' then
if redis:get('Lock:HashTag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل هشتگ از قبل فعال بود.`' , 'md')
else 
...
if redis:get('Lock:HashTag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Hᴀsʜᴛᴀɢ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else 
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Hᴀsʜᴛᴀɢ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:HashTag:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل هشتگ از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock hashtag' then
if redis:get('Lock:HashTag:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Hᴀsʜᴛᴀɢ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:HashTag:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Hᴀsʜᴛᴀɢ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل سلفی' then
if redis:get('Lock:Video_note:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل ویدیو سلفی از قبل فعال بود.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`⇋ قفل ویدیو سلفی فعال شد.`' , 'md')
redis:set('Lock:Video_note:'..msg.chat_id,true)
end
end
if matches == 'lock self' then
if redis:get('Lock:Video_note:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ VɪᴅᴇᴏNᴏᴛᴇ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ VɪᴅᴇᴏNᴏᴛᴇ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Video_note:'..msg.chat_id,true)
end
end
if matches == 'بازکردن سلفی' then
if redis:get('Lock:Video_note:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل ویدیو سلفی غیرفعال شد.`' , 'md')
redis:del('Lock:Video_note:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`⇋ قفل ویدیو سلفی از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock self' then
if redis:get('Lock:Video_note:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ VɪᴅᴇᴏNᴏᴛᴇ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Video_note:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ VɪᴅᴇᴏNᴏᴛᴇ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل هرزنامه' then
if redis:get('Spam:Lock:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل هرزنامه از قبل فعال بود.`' , 'md')
else
...
if redis:get('Spam:Lock:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴘᴀᴍ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴘᴀᴍ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Spam:Lock:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل هرزنامه از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock spam' then
if redis:get('Spam:Lock:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴘᴀᴍ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Spam:Lock:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴘᴀᴍ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل اینلاین' then
if redis:get('Lock:Inline:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل اینلاین از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Inline:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Iɴʟɪɴᴇ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Iɴʟɪɴᴇ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Inline:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل اینلاین از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock inline' then
if redis:get('Lock:Inline:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Iɴʟɪɴᴇ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Inline:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Iɴʟɪɴᴇ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل پیام مکرر' then
if redis:get('Lock:Flood:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل پیام مکرر از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Flood:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fʟᴏᴏᴅ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fʟᴏᴏᴅ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Flood:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل پیام مکرر غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock flood' then
if redis:get('Lock:Flood:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fʟᴏᴏᴅ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Flood:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fʟᴏᴏᴅ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل فروارد' then
if redis:get('Lock:Forward:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل فروارد از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Forward:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fᴏʀᴡᴀʀᴅ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fᴏʀᴡᴀʀᴅ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Forward:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل فروارد از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock forward' then
if redis:get('Lock:Forward:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fᴏʀᴡᴀʀᴅ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Forward:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Fᴏʀᴡᴀʀᴅ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل فارسی' then
if redis:get('Lock:Arabic:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل فارسی از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Arabic:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pᴇʀsɪᴀɴ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pᴇʀsɪᴀɴ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Arabic:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل فارسی از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock farsi' then
if redis:get('Lock:Arabic:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pᴇʀsɪᴀɴ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Arabic:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pᴇʀsɪᴀɴ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل ربات' then
if redis:get('Lock:Bot:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل ربات از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Bot:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Bᴏᴛs Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Bᴏᴛs Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Bot:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل ربات غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock bot' then
if redis:get('Lock:Bot:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Bᴏᴛs Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Bot:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Bᴏᴛs Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل ویرایش' then
if redis:get('Lock:Edit'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل ویرایش از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Edit'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eᴅɪᴛ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eᴅɪᴛ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Edit'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل ویرایش از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock edit' then
if redis:get('Lock:Edit'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eᴅɪᴛ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Edit'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eᴅɪᴛ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل انگلیسی' then
if redis:get('Lock:English:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل انگلیسی از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:English:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eɴɢʟɪsʜ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eɴɢʟɪsʜ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:English:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل انگلیسی غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock english' then
if redis:get('Lock:English:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eɴɢʟɪsʜ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:English:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Eɴɢʟɪsʜ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل سرویس' then
if redis:get('Lock:TGservise:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل سرویس تلگرام از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:TGservise:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ TGSᴇʀᴠɪᴄᴇ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ TGSᴇʀᴠɪᴄᴇ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:TGservise:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل سرویس تلگرام از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock tgservice' then
if redis:get('Lock:TGservise:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ TGSᴇʀᴠɪᴄᴇ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:TGservise:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ TGSᴇʀᴠɪᴄᴇ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل استیکر' then
if redis:get('Lock:Sticker:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل استیکر از قبل فعال بود.`' , 'md')
else
...
if redis:get('Lock:Sticker:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴛɪᴄᴋᴇʀ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴛɪᴄᴋᴇʀ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Lock:Sticker:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل استیکر از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock sticker' then
if redis:get('Lock:Sticker:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴛɪᴄᴋᴇʀ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Lock:Sticker:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Sᴛɪᴄᴋᴇʀ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل متن' then
if redis:get('Mute:Text:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل متن از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Text:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴇxᴛ IS AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴇxᴛ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Text:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل متن از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock text' then
if redis:get('Mute:Text:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴇxᴛ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Text:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Tᴇxᴛ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل مخاطب' then
if redis:get('Mute:Contact:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل مخاطب از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Contact:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Cᴏɴᴛᴀᴄᴛ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Cᴏɴᴛᴀᴄᴛ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Contact:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل مخاطب از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock contact' then
if redis:get('Mute:Contact:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Cᴏɴᴛᴀᴄᴛ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Contact:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Cᴏɴᴛᴀᴄᴛ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل فایل' then
if redis:get('Mute:Document:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل فایل از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Document:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Dᴏᴄᴜᴍᴇɴᴛ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Dᴏᴄᴜᴍᴇɴᴛ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Document:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل فایل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock document' then
if redis:get('Mute:Document:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Dᴏᴄᴜᴍᴇɴᴛ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Document:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Dᴏᴄᴜᴍᴇɴᴛ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل موقعیت' then
if redis:get('Mute:Location:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل موقعیت از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Location:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lᴏᴄᴀᴛɪᴏɴ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lᴏᴄᴀᴛɪᴏɴ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Location:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل موقعیت از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock location' then
if redis:get('Mute:Location:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lᴏᴄᴀᴛɪᴏɴ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Location:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Lᴏᴄᴀᴛɪᴏɴ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل ویس' then
if redis:get('Mute:Voice:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل ویس از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Voice:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vᴏɪᴄᴇ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vᴏɪᴄᴇ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Voice:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل ویس از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock voice' then
if redis:get('Mute:Voice:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vᴏɪᴄᴇ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Voice:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vᴏɪᴄᴇ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل عکس' then
if redis:get('Mute:Photo:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل عکس از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Photo:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pʜᴏᴛᴏ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pʜᴏᴛᴏ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Photo:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل عکس از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock photo' then
if redis:get('Mute:Photo:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pʜᴏᴛᴏ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Photo:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Pʜᴏᴛᴏ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل بازی' then
if redis:get('Mute:Game:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل بازی از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Game:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gᴀᴍᴇ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gᴀᴍᴇ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Game:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل بازی از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock game' then
if redis:get('Mute:Game:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gᴀᴍᴇ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Game:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gᴀᴍᴇ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل فیلم' then
if redis:get('Mute:Video:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل فیلم از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Video:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vɪᴅᴇᴏ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vɪᴅᴇᴏ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Video:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل فیلم از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock video' then
if redis:get('Mute:Video:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vɪᴅᴇᴏ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Video:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Vɪᴅᴇᴏ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل آهنگ' then
if redis:get('Mute:Music:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل آهنگ از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Music:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Mᴜsɪᴄ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Mᴜsɪᴄ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Music:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل آهگ از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock music' then
if redis:get('Mute:Music:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Mᴜsɪᴄ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Music:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Mᴜsɪᴄ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
if matches == 'قفل گیف' then
if redis:get('Mute:Gif:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`⇋ قفل گیف از قبل فعال بود.`' , 'md')
else
...
if redis:get('Mute:Gif:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gɪғ Is AʟRᴇᴀᴅʏ Eɴᴀʙʟᴇᴅ.`' , 'md')
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gɪғ Hᴀs Bᴇᴇɴ Eɴᴀʙʟᴇ.`' , 'md')
redis:set('Mute:Gif:'..msg.chat_id,true)
end
end
...
sendText(msg.chat_id, msg.id, '`⇋ قفل گیف از قبل غیرفعال بود.`' , 'md')
end
end
if matches == 'unlock gif' then
if redis:get('Mute:Gif:'..msg.chat_id) then
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gɪғ Hᴀs Bᴇᴇɴ Dɪsᴀʙʟᴇ.`' , 'md')
redis:del('Mute:Gif:'..msg.chat_id)
else
sendText(msg.chat_id, msg.id, '`✪ Lᴏᴄᴋ Gɪғ Is AʟRᴇᴀᴅʏ Dɪsᴀʙʟᴇᴅ.`' , 'md')
end
end
----------------------------------------------------------------------------------
